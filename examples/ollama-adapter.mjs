 ...
 *
 * ayin does NOT speak Ollama's native API. It speaks a small "endpoint-shaped" HTTP
 ...
 * point ayin at it with AYIN_LLM_URL and run fully local — no Maradel backend needed.
 *
 * Usage:
