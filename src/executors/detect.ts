...
const REQUEST_PATTERNS: Array<[ProjectType, RegExp]> = [
  ...
  // The broad one goes LAST of the last: `react`, `vite`, `.tsx` and a bare `ts <noun>` are the
  // widest net in the file, so anything above must get the chance to claim the request first.
