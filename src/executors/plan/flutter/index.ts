...
export const flutterPlanExecutor: PlanExecutor = {
  ...
  grounding(ctx: ProjectContext, request?: string): string {
    ...
    const lines = [
      ...
      'lib/router/app_router.gr.dart by hand — the next generator pass overwrites it. app_router.dart',
      'imports and re-exports it, so a view needs only `import \'../router/app_router.dart\'`.',
      '',
